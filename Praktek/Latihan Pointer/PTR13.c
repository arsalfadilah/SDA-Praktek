...
void succI (int i); /* suksessor, berupa procedure by ref * void predI (int i); /* predesessor */
void succC (char *c); /* suksessor, berupa procedure by ref * void predC (char *c); /* predesessor */
...
printtab ((char *) MyTabC, 1); printf("\n");

/* Pakai geser dengan parameter succ */
printf("Geser dengan succ \n");
geser ((int *) MyTabInt, (int *) succI);
geser ((char *) MyTabC, (char *) succC); printf(" dalam main \n");
printf(" Tabel integer \n"); printtab ((int *) MyTabInt, 0); printf(" Tabel charakter \n"); printtab ((char *) MyTabC, 1); printf("\n");

/* Pakai geser dengan parameter pred */ printf("Geser dengan pred \n");
geser ((int *) MyTabInt, (int *) predI); geser ((char *) MyTabC, (char *) predC); printf(" dalam main \n");
printf(" Tabel integer \n"); printtab ((int *) MyTabInt, 0); printf(" Tabel charakter \n"); printtab ((char *) MyTabC, 1); printf("\n");
return 0;
}

/*Body Function */ void succI (int *i){
*i = *i+1;
}
void predI (int i){
*i = *i-1;
...
void printtab (void *T, enum MyType Ty){ int i;
for (i = 0; i < N; i ++) {
switch (Ty) {
case bulat : printf("%d ", (int *) *(T + i)); break; case karakter : printf("%c ", (char *) *(T + i)); break;
}
}
}
